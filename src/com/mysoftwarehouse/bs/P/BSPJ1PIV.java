...
import com.mysoftwarehouse.bs.db.PIV.PIV_PJ1PIV;
 ...
 * @author Ng Siak Hooi
 */
public class BSPJ1PIV extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSPJ1PIV.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSPX1PIV.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSPJ1PIV.title";
        ...
        String reportSubTitle = "BSPJ1PIV.subtitle.{0}.{1}";
