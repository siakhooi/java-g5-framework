...
import com.mysoftwarehouse.bs.db.RCP.RCP_PJ0RCP;
 ...
 * @author Ng Siak Hooi
 */
public class BSPJ0RCP extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSPJ0RCP.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSPX0RCP.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSPJ0RCP.title";
        ...
        String reportSubTitle = "BSPJ0RCP.subtitle.{0}.{1}";
