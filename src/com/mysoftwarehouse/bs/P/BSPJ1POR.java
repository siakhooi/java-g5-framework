...
import com.mysoftwarehouse.bs.db.POR.POR_PJ1POR;
 ...
 * @author Ng Siak Hooi
 */
public class BSPJ1POR extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSPJ1POR.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSPX1POR.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSPJ1POR.title";
        ...
        String reportSubTitle = "BSPJ1POR.subtitle.{0}.{1}";
