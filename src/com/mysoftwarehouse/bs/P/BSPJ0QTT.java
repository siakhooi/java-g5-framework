...
import com.mysoftwarehouse.bs.db.QTT.QTT_PJ0QTT;
 ...
 * @author Ng Siak Hooi
 */
public class BSPJ0QTT extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSPJ0QTT.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSPX0QTT.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSPJ0QTT.title";
        ...
        String reportSubTitle = "BSPJ0QTT.subtitle.{0}.{1}";
