...
import com.mysoftwarehouse.bs.db.INV.INV_PJ0INV;
 ...
 * @author Ng Siak Hooi
 */
public class BSPJ0INV extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSPJ0INV.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSPX0INV.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSPJ0INV.title";
        ...
        String reportSubTitle = "BSPJ0INV.subtitle.{0}.{1}";
