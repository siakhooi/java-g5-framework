...
import com.mysoftwarehouse.bs.db.INV.INV_IJ3INVD;
 ...
 * @author Ng Siak Hooi
 */
public class BSIJ3INVD extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        String r = REPORT.REPORT_PATH + "BSIX3INVD.jasper";
        InputStream in = BSIJ3INVD.class.getResourceAsStream(r);
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            INV_IJ3INVD.select(this, rsName, Cmp, FrmCus, ToCus, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSIJ3INVD.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSIJ3INVD.title";
        ...
        String reportSubTitle = "BSIJ3INVD.subtitle.{0}.{1}";
