...
import com.mysoftwarehouse.bs.db.INV.INV_IJ2INV;
 ...
 * @author Ng Siak Hooi
 */
public class BSIJ2INV extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSIJ2INV.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSIX2INV.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSIJ2INV.title";
        ...
        String reportSubTitle = "BSIJ2INV.subtitle.{0}.{1}";
