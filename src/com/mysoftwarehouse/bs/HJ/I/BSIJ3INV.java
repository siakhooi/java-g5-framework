...
import com.mysoftwarehouse.bs.db.INV.INV_IJ3INV;
 ...
 * @author Ng Siak Hooi
 */
public class BSIJ3INV extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        String r = REPORT.REPORT_PATH + "BSIX3INV.jasper";
        InputStream in = BSIJ3INV.class.getResourceAsStream(r);
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            INV_IJ3INV.select(this, rsName, Cmp, FrmCus, ToCus, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSIJ3INV.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSIJ3INV.title";
        ...
        String reportSubTitle = "BSIJ3INV.subtitle.{0}.{1}";
