...
import com.mysoftwarehouse.bs.db.RCP.RCP_JJ3RCP;
 ...
 * @author Ng Siak Hooi
 */
public class BSJJ3RCP extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        String r = REPORT.REPORT_PATH + "BSJX3RCP.jasper";
        InputStream in = BSJJ3RCP.class.getResourceAsStream(r);
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            RCP_JJ3RCP.select(this, rsName, Cmp, FrmCus, ToCus, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSJJ3RCP.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSJJ3RCP.title";
        ...
        String reportSubTitle = "BSJJ3RCP.subtitle.{0}.{1}";
