...
import com.mysoftwarehouse.bs.db.RCP.RCP_JJ2RCP;
 ...
 * @author Ng Siak Hooi
 */
public class BSJJ2RCP extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSJJ2RCP.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSJX2RCP.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSJJ2RCP.title";
        ...
        String reportSubTitle = "BSJJ2RCP.subtitle.{0}.{1}";
