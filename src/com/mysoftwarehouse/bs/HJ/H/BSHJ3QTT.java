...
import com.mysoftwarehouse.bs.db.QTT.QTT_HJ3QTT;
 ...
 * @author Ng Siak Hooi
 */
public class BSHJ3QTT extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        String r = REPORT.REPORT_PATH + "BSHX3QTT.jasper";
        InputStream in = BSHJ3QTT.class.getResourceAsStream(r);
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            QTT_HJ3QTT.select(this, rsName, Cmp, FrmCus, ToCus, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSHJ3QTT.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSHJ3QTT.title";
        ...
        String reportSubTitle = "BSHJ3QTT.subtitle.{0}.{1}";
