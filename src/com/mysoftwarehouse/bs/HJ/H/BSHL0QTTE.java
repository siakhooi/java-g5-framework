 ...
 * @author Ng Siak Hooi
 */
public class BSHL0QTTE extends ListForm {
    ...
    protected void buildDataList() {
        super.addTextField("Text", "BSQTTE.Text");
        super.setFieldHelpMessage("BSQTTE.Text.help");
    }
    ...
    protected void buildGeneral() {
        ...
        super.setEditForm(BSHT0QTTE.class);
    }
    ...
    public void executeReload(int arg0, int[] arg1) {
        try {
            ...
            String rsName = "BSHL0QTTE";
            QTTE.selectAll(this, rsName, Cmp, QttNo, Itm);
            useSQL(rsName);
        } catch (SQLException ex) {
            String title = "BSHL0QTTE.error";
            cmd.log.severe(title, ex);
            cmd.common.showMessage(DialogMessageType.ERROR,
                    title, "BSHL0QTTE.error.description");
        }
    }
