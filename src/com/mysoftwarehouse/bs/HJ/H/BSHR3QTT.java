 ...
 * @author Ng Siak Hooi
 */
public class BSHR3QTT extends ReportEntryForm {

    @Override
    protected void buildFieldList() {
        super.addTextField("FrmCus", "BSHR3QTT.FrmCus");
        super.setFieldHelpMessage("BSHR3QTT.FrmCus.help");
        ...
        super.addTextField("ToCus", "BSHR3QTT.ToCus");
        super.setFieldHelpMessage("BSHR3QTT.ToCus.help");
        super.setFieldMandatory(false);
        super.setFieldMaximumLength(10);
        super.setFieldSelectForm(BSCL1CUS.class);
        super.setFieldTextCaseType(TextCaseType.UPPER);
        ...
        super.addBooleanField("Active", "BSHR3QTT.Active");
        super.setFieldHelpMessage("BSHR3QTT.Active.help");
        super.addBooleanField("Inactive", "BSHR3QTT.Inactive");
        super.setFieldHelpMessage("BSHR3QTT.Inactive.help");
    }

    @Override
    public Class<? extends ReportExecutionForm> getReportForm() {
        return BSHJ3QTT.class;
    }
    ...
    public void onOutExit() {
        try {
            ...
            cmd.log.sysSevere("BSHR3QTT.error", ex);
        }
    }
