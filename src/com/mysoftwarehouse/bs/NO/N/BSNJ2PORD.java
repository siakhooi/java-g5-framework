...
import com.mysoftwarehouse.bs.db.POR.POR_NJ2PORD;
 ...
 * @author Ng Siak Hooi
 */
public class BSNJ2PORD extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSNJ2PORD.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSNX2PORD.jasper");
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSNJ2PORD.title";
        ...
        String reportSubTitle = "BSNJ2PORD.subtitle.{0}.{1}";
