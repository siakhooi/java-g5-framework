...
import com.mysoftwarehouse.bs.db.PIV.PIV_OJ2PIVD;
 ...
 * @author Ng Siak Hooi
 */
public class BSOJ2PIVD extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSOJ2PIVD.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSOX2PIVD.jasper");
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            String rsName = "BSOJ2PIVD";
            Cmp = GET.Cmp(this);
            frmDte = cmd.in.map.calendars.get(MAP.BSPIV.FROMDATE);
            toDte = cmd.in.map.calendars.get(MAP.BSPIV.TODATE);

            PIV_OJ2PIVD.select(this, rsName, Cmp, frmDte, toDte);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSOJ2PIVD.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSOJ2PIVD.title";
        ...
        String reportSubTitle = "BSOJ2PIVD.subtitle.{0}.{1}";
