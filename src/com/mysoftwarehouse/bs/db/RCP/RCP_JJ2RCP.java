...
import com.mysoftwarehouse.bs.HJ.J.BSJJ2RCP;
 ...
 * @author Ng Siak Hooi
 */
public class RCP_JJ2RCP {

    public static void select(BSJJ2RCP form, String rsName, String Cmp, Calendar FrmDte, Calendar ToDte)
            throws SQLException {

        String sql = "SELECT B.Nme CusNme, * FROM BSRCP A, BSCUS B ";
