...
import com.mysoftwarehouse.bs.CG.C.BSCJ2CUS;
 ...
 * @author Ng Siak Hooi
 */
public class CUS_CJ2CUS {

    public static void select(BSCJ2CUS form, String rsName, String Cmp,
            String FrmCus, String ToCus, boolean active, boolean inactive)
            throws SQLException {
        String sql = "SELECT * FROM BSCUS A, BSCUSC B ";
