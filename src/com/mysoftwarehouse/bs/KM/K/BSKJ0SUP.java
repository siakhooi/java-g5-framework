...
import com.mysoftwarehouse.bs.db.SUP.SUP_KJ0SUP;
 ...
 * @author Ng Siak Hooi
 */
public class BSKJ0SUP extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSKJ0SUP.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSKX0SUP.jasper");
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            SUP_KJ0SUP.select(this, rsName, Cmp, frmSup, toSup, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSKJ0SUP.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSKJ0SUP.title";
        ...
        String reportSubTitle = "BSKJ0SUP.subtitle.{0}.{1}";
