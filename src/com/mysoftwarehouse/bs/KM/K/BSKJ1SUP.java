...
import com.mysoftwarehouse.bs.db.SUP.SUP_KJ1SUP;
 ...
 * @author Ng Siak Hooi
 */
public class BSKJ1SUP extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSKJ0SUP.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSKX1SUP.jasper");
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            SUP_KJ1SUP.select(this, rsName, Cmp, frmSup, toSup, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSKJ1SUP.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSKJ1SUP.title";
        ...
        String reportSubTitle = "BSKJ1SUP.subtitle.{0}.{1}";
