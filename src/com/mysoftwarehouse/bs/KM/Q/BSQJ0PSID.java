...
import com.mysoftwarehouse.bs.db.PSI.PSI_QJ0PSID;
 ...
 * @author Ng Siak Hooi
 */
public class BSQJ0PSID extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSQJ0PSID.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSQX0PSID.jasper");
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            PSI_QJ0PSID.select(this, rsName, Cmp, FrmSpcInst, ToSpcInst, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSQJ0PSID.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSQJ0PSID.title";
        ...
        String reportSubTitle = "BSQJ0PSID.subtitle.{0}.{1}";
