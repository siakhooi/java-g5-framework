...
import com.mysoftwarehouse.bs.db.PI.PI_LJ2PI;
 ...
 * @author Ng Siak Hooi
 */
public class BSLJ2PI extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSLJ2PI.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSLX2PI.jasper");
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            PI_LJ2PI.select(this, rsName, Cmp, FrmItm, ToItm, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSLJ2PI.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSLJ2PI.title";
        ...
        String reportSubTitle = "BSLJ2PI.subtitle.{0}.{1}";
