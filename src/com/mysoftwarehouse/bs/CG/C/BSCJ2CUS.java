...
import com.mysoftwarehouse.bs.db.CUS.CUS_CJ2CUS;
 ...
 * @author Ng Siak Hooi
 */
public class BSCJ2CUS extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSCJ0CUS.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSCX2CUS.jasper");
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            CUS_CJ2CUS.select(this, rsName, Cmp, frmCus, toCus, active, inactive);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSCJ2CUS.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSCJ2CUS.title";
        ...
        String reportSubTitle = "BSCJ2CUS.subtitle.{0}.{1}";
