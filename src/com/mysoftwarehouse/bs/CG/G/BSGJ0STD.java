...
import com.mysoftwarehouse.bs.db.ST.ST_GJ0STD;
 ...
 * @author Ng Siak Hooi
 */
public class BSGJ0STD extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        InputStream in = BSGJ0STD.class.getResourceAsStream(
                REPORT.REPORT_PATH + "BSGX0STD.jasper");
    ...
    protected void prepareExecution() throws ReportExecutionException {
        try {
            ...
            ST_GJ0STD.select(this, rsName, Cmp, FrmTrm, ToTrm, active, inactive,
                    forQtt, forInv, forRcp);
            super.useResultSetDataSource(rsName);
        } catch (SQLException ex) {
            cmd.log.severe("BSGJ0STD.error", ex);
        }
    }
    ...
    protected void initExecution() throws ReportExecutionException {
        ...
        String reportTitle = "BSGJ0STD.title";
        ...
        String reportSubTitle = "BSGJ0STD.subtitle.{0}.{1}";
