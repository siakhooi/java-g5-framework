 ...
 * @author Ng Siak Hooi
 */
public class HelloReportExecution extends ReportExecutionForm {

    @Override
    protected void initReport() throws ReportExecutionException {
        String name = "/com/mysoftwarehouse/toolkit/demo/resources/reports/demo1.jasper";
        super.loadCompiledReport(HelloReportExecution.class.getResourceAsStream(name));
    ...
    public String getFormTitle() {
        return "HelloReportExecution.title";
    }
