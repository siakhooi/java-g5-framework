 ...
 * @author Ng Siak Hooi
 */
public class HelloProcessTestProcessCancel extends ProcessForm {
    ...
    public void processCancel() throws ProcessException {
        super.setI18nProgressMessage("process 111 Cancelled");
    }
    ...
    public String getFormTitle() {
        return "HelloProcessTestProcessCancel.title";
    }
