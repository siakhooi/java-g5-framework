 ...
 * @author Ng Siak Hooi
 */
public class PFAP0DB101 extends ProcessForm {
    ...
    public void init() {
        ...
        addProcess("PFAP0DB101.ShowLicense", 1);
        addProcess("PFAP0DB101.LoadScript", 1);
        addProcess("PFAP0DB101.CreateDatabase", 9);
    }
    ...
    private void loadScript() throws ProcessException {
        try {
            ...
            Sql2Vector.add(this, allSql,
                    PFAP0DB101.class.getResourceAsStream(RESOURCE.DATABASE_100_FILE));
            Sql2Vector.add(this, allSql,
                    PFAP0DB101.class.getResourceAsStream(RESOURCE.DATABASE_101_FILE));
        } catch (IOException ex) {
            cmd.log.severe("PFAP0DB101.error", ex);
            String msg = "PFAP0DB101.error.{0}";
