 ...
 * @author Ng Siak Hooi
 */
public class PFAP0DB101To102 extends ProcessForm {
    ...
    public void init() {
        ...
        addProcess("PFAP0DB101To102.LoadScript", 1);
        addProcess("PFAP0DB101To102.CreateDatabase", 9);
    }
    ...
    private void loadScript() throws ProcessException {
        try {
            ...
            Sql2Vector.add(this, allSql, 
                    PFAP0DB101To102.class.getResourceAsStream(RESOURCE.DATABASE_102_FILE));
        } catch (IOException ex) {
            cmd.log.severe("PFAP0DB101To102.error", ex);
            String msg = "PFAP0DB101To102.error.{0}";
