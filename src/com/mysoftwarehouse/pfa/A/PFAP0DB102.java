 ...
 * @author Ng Siak Hooi
 */
public class PFAP0DB102 extends ProcessForm {
    ...
    public void init() {
        ...
        addProcess("PFAP0DB102.ShowLicense", 1);
        addProcess("PFAP0DB102.LoadScript", 1);
        addProcess("PFAP0DB102.CreateDatabase", 9);
    }
    ...
    private void loadScript() throws ProcessException {
        try {
            ...
            Sql2Vector.add(this, allSql,
                    PFAP0DB102.class.getResourceAsStream(RESOURCE.DATABASE_100_FILE));
            Sql2Vector.add(this, allSql,
                    PFAP0DB102.class.getResourceAsStream(RESOURCE.DATABASE_101_FILE));
            Sql2Vector.add(this, allSql,
                    PFAP0DB102.class.getResourceAsStream(RESOURCE.DATABASE_102_FILE));

//            allSql = new Vector<String>();
//            cmd.lineread.init(PFAP0DB102.class.getResourceAsStream(RESOURCE.DATABASE_100_FILE));
//            String line = "";
//            String currentSQL = "";
...
//            }
            ...
            cmd.log.severe("PFAP0DB102.error", ex);
            String msg = "PFAP0DB102.error.{0}";
