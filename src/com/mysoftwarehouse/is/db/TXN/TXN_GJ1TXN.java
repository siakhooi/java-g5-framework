...
import com.mysoftwarehouse.is.G.ISGJ1TXN;
 ...
 * @author Ng Siak Hooi
 */
public class TXN_GJ1TXN {

    public static void select(ISGJ1TXN form, String rsName,
        ...
        sql += "ORDER BY A.Whs, A.Itm, A.TxnDte, A.TxnTme ";
