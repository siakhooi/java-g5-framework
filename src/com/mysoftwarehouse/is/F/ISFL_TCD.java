 ...
 * @author Ng Siak Hooi
 */
public abstract class ISFL_TCD extends ListForm {
    ...
    public void executeReload(int arg0, int[] arg1) {
        try {
            ...
            String rsName = "ISFL_TCD";
            TCD.select_All(this, rsName, Whs, getTxnTyp().typ);
            useSQL(rsName);
        } catch (SQLException ex) {
            String title = "ISFL_TCD.error";
            cmd.log.severe(title, ex);
            cmd.common.showMessage(DialogMessageType.ERROR,
                    title,
                    "ISFL_TCD.error.description");
        }
    }
