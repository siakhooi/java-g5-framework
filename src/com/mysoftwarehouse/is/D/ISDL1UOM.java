 ...
 * @author Ng Siak Hooi
 */
public class ISDL1UOM extends ListForm {
    ...
    public void executeReload(int arg0, int[] arg1) {
        try {
            ...
            String rsName = "ISDL1UOM";
            UOM.select_All(this, rsName, Whs);
            useSQL(rsName);
        } catch (SQLException ex) {
            String title = "ISDL1UOM.error";
            cmd.log.severe(title, ex);
            cmd.common.showMessage(DialogMessageType.ERROR,
                    title,
                    "ISDL1UOM.error.description");
        }
    }
    ...
    public void executeSelect(int selectedRow, int[] selectedRows) throws Exception {
        String uom = cmd.list.getString(selectedRow, "Uom");
        cmd.in.stringValue = uom;
    }

    @Override
    public String getFormTitle() {
        return "ISDL1UOM.title";
    }
}
