 ...
 * @author Ng Siak Hooi
 */
public class ISEL1LOC extends ListForm {
    ...
    public void executeReload(int arg0, int[] arg1) {
        try {
            ...
            String rsName = "ISEL1LOC";
            LOC.select_All(this, rsName, Whs);
            useSQL(rsName);
        } catch (SQLException ex) {
            String title = "ISEL1LOC.error";
            cmd.log.severe(title, ex);
            cmd.common.showMessage(DialogMessageType.ERROR,
                    title,
                    "ISEL1LOC.error.description");
        }
    }
    ...
    public void executeSelect(int selectedRow, int[] selectedRows) throws Exception {
        String loc = cmd.list.getString(selectedRow, "Loc");
        cmd.in.stringValue = loc;
    }

    @Override
    public String getFormTitle() {
        return "ISEL1LOC.title";
    }
}
