...
import com.gqrsoft.g5.kernel.framepanel.entry.entryField.component.f2dataentry.NumericFormattedTextField;
...
import com.gqrsoft.g5.kernel.framepanel.entry.entryField.component.f4contextmenu.NumericTextFieldContextMenu;
import com.gqrsoft.g5.kernel.framepanel.entry.entryField.component.f5functionkey.NumericAcceleratorKeyListener;
...
import com.gqrsoft.g5.kernel.framepanel.entry.entryField.util.SelectNumericFactory;
import com.gqrsoft.g5.kernel.framepanel.entry.entryField.value.f8valuecontrol.NumericValue;
 ...
 * @author Ng Siak Hooi
 */
public class NumericEntryField extends AbstractEntryField {

    private NumericFormattedTextField textfield;
    ...
    public void init() {
        ...
        // 2 dataentry
        textfield = new NumericFormattedTextField();
        ...
        // 4 context menu
        NumericTextFieldContextMenu f4 = new NumericTextFieldContextMenu();
        super.contextMenu = f4;
        super.allGuiComponents.add(f4);
        textfield.addMouseListener(new ContextMenuMouseListener(f4));

        // 5 function key
        NumericAcceleratorKeyListener f5 =
                new NumericAcceleratorKeyListener();
        ...
        // 8 value control
        NumericValue f8 = new NumericValue();
        f8.init(formControl, this);
        super.value = f8;

        // 9 value verifier
        NumericValueVerifier f9 = new NumericValueVerifier();
    ...
    public void executeAction(FieldAction t) {
        switch (t) {
            ...
            case SHOWSELECT:
                ...
                SelectNumericFactory.selectNumeric(formControl, this);
