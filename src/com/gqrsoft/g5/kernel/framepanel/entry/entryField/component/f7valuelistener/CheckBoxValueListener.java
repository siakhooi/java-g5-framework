 ...
 * @author Ng Siak Hooi
 */
public class CheckBoxValueListener extends AbstractValueListener {

    private BooleanCheckBox dataField;
    //private boolean tempLost = false;

    public CheckBoxValueListener(BooleanCheckBox dataField) {
